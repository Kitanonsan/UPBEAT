...
public class NearbyTest {
        ...
        for(int i = 0 ; i < Configuration.instance().m -1 ; i++){
            for(int j = 0 ; j < Configuration.instance().n ; j++){
                for(int k = 1 ; k < Configuration.instance().m-i ; k++){
                    ...
                    assertEquals(100*k+100,p1.nearby("up"));
                    System.out.println();
                }
            }
        }
        ...
        for(int i = 0 ; i < Configuration.instance().m -1 ; i++){
            for(int j = 0 ; j < Configuration.instance().n ; j++){
                for(int k = 1 ; k < Configuration.instance().m-i ; k++){
                    ...
                    assertEquals(100*k+100,p1.nearby("down"));
                    System.out.println();
                }
            }
        }
    ...
    void UpRightNearbyTest(){
        ...
        p1.printPosition();
        assertEquals(300,p1.nearby("upright"));
    }
    ...
    void UpLeftNearbyTest(){
        ...
        p1.printPosition();
        assertEquals(200,p1.nearby("upleft"));
    }
    ...
    void DownRightNeabyTest(){
        ...
        p1.printPosition();
        assertEquals(200,p1.nearby("downright"));
    }
    ...
    void DownLeftNeabyTest(){
        ...
        p1.printPosition();
        assertEquals(200,p1.nearby("downleft"));
    }
