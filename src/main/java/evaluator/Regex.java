...
public class Regex {
    public static String Regex = "([+*/%^-])|([0-9]+)|(=)|([{()}])|\\d(collect|done|down|downleft|downright|up|upleft|upright|invest|opponent|nearby|move|relocate|shoot|if|else|then|while)\\d|([a-zA-Z]+[a-zA-Z0-9]*)|([^ \\r\\n]+)";
